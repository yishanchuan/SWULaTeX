...
% ===================
  cauthor = \secretize{易山川},	% 你的姓名，以下每项都以英文逗号结束
  eauthor = \secretize{shanchuan~Yi},	% 姓名拼音，~代表不会断行的空格
  studentid = \secretize{××××××××},	% 仅本科生，学号
  csupervisor = \secretize{Right~~教授},	% 导师的姓名
  esupervisor = \secretize{{Prof.~Zhiming Liu}},	% 导师的姓名拼音
  ...
  cclass = 工学,	% 博士生和学硕填学科门类，专硕填学科类型
  edgree = {Degree of Master of Enginnering},	% 专硕填Professional Degree，其他按实情填写
% 提示：如果内容太长，可以用\zihao{}命令控制字号，作用范围：{}内
  cmajor = {计算机应用技术},	% 专硕不需填，填写专业名称
  emajor = Computer Application Technology, % % 专硕不需填，填写专业英文名称
% ===================
% 底部的学院名称和日期
% ===================
  cdepartment = 计算机与信息科学学院,	%学院名称
  edepartment = College of Computer and Information Science,	%学院英文名称
% ===================
